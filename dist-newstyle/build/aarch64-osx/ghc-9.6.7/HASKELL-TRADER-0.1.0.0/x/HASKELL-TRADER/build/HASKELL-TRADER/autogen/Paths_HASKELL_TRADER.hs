...
-- at runtime using the environment variable HASKELL_TRADER_bindir.
...
-- environment variable HASKELL_TRADER_libdir.
...
-- using the environment variable HASKELL_TRADER_dynlibdir.
...
-- runtime using the environment variable HASKELL_TRADER_datadir.
...
-- variable HASKELL_TRADER_libexedir.
...
-- using the environment variable HASKELL_TRADER_sysconfdir.
